...
* You can also use "in", "out" and "down" and "up" as Direction Commands for specific situations.

## Items
### Pick Items
To pick a specified item you should type the command "pick [Item]", "take [Item]" or get [item].
